...
namespace FreeTaskBackend.Migrations
{
    ...
    [Migration("20250621010534_AddMultipleEntitiesAndProperties")]
    partial class AddMultipleEntitiesAndProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeTaskBackend.Models.PortfolioItem", b =>
                {
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "portfolio");
                });
            ...
            modelBuilder.Entity("FreeTaskBackend.Models.SmartFilter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FreeTaskBackend.Models.PortfolioItem", b =>
                {
                    b.HasOne("FreeTaskBackend.Models.FreelancerProfile", null)
                        .WithMany("Portfolio")
